    ...
    <div class="container">
        ...
        <div class="row">
            ...
            while ($r = mysqli_fetch_array($query_res)) {
                ...
                $avg = $count_review > 0 ? round($r['rating'] / $count_review) : 0;
                $rate = "";
                for ($i = 0; $i < 5; $i++) {
                    if ($i < $avg) {
                                            ...
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content" style="height: 350px">
                                                    ...
                                                    <div style="display: flex; padding-bottom: 20px; justify-content:space-between; align-items: center " >
                                                        ...
                                                        <p style="cursor:pointer; color: blue; margin:0" data-toggle="modal" data-target="#exampleModal' . $r['d_id'] . '">' . $count_review . ' Reviews</p>
                                                    </div>
