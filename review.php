														   ...
														   <?php 
																		   ...
																		   <?php 
																			...
																			?>
																			 ...
																			 <button type="button" class="btn btn-success"><span  class="fa fa-check-circle"></span> <a href="https://www.w3schools.com/">Leave a Review</a></button>
     ...
     <div class="container-fluid">
         <!-- Start Page Content -->
                 ...
                 <div class="card card-outline-primary">
                     <div class="card-header" style="background-color:#33475b">
                         <h4 class="m-b-0 text-white">Leave a Review</h4>
                     </div>
                     <div class="card-body">
                                 ...
                                 <div class="row p-t-20">
                                     <div class="col-md-12">
                                         <div class="form-group">
                                             ...
                                             <input type="text" name="d_name" class="form-control" >stars here
                                            </div>
                                     </div>
