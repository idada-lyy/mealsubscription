    ...
    if (empty($_POST['d_name']) || empty($_POST['about']) || $_POST['price'] == '' || $_POST['res_name'] == '') {
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            if ($fsize >= 1000000) {
                ...
                $sql = "INSERT INTO dishes(rs_id,title,slogan,price,allergies, diets,ingredients,img) VALUE('" . $_POST['res_name'] . "','" . $_POST['d_name'] . "','" . $_POST['about'] . "','" . $_POST['price'] . "','" . $_POST['allergies'] . "','" . $_POST['diets'] . "','" . $_POST['ingredients'] . "','" . $fnew . "')";  // store the submited data ino the database :imagemysqli_query($db, $sql);
                mysqli_query($db, $sql);
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="text" name="ingredients" class="form-control form-control-danger">
                                        </div>
                                    </div>
                                </div>
