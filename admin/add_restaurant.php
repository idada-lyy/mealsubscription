                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Select Diets</label>
													    <input name="<?php echo $result['id']?>" type="checkbox" id="<?php echo $result['id']?>" value="<?php echo $result['id']?>">
                                                    </label></td>
                                                    <td width="30%" align="center"><?php echo $result['city']?></td>
                                                    <td width="30%" align="center"><?php echo $result['country']?></td>
                                                </div>
                                            </div>
                                            -->
