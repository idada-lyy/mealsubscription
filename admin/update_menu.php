        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            if ($fsize >= 1000000) {
                ...
                if (!empty($_POST['allergies'])) {
                    $set[] = "allergies='$_POST[allergies]'";
                }
                if (!empty($_POST['diets'])) {
                    $set[] = "diets='$_POST[diets]'";
                }
                if (!empty($_POST['ingredients'])) {
                    $set[] = "ingredients='$_POST[ingredients]'";
                }


                $sql = "update dishes set title='$_POST[d_name]',slogan='$_POST[about]',price='$_POST[price]',img='$fnew'" . (empty(implode(",",$set)) ? "" : "," . implode(",",$set)) . " where d_id='$_GET[menu_upd]'";
                mysqli_query($db, $sql);
            ...
            $sql = "update dishes set title='$_POST[d_name]',slogan='$_POST[about]',price='$_POST[price]'" . (empty(implode(",",$set)) ? "" : "," . implode(",",$set)) . " where d_id='$_GET[menu_upd]'";
                        ...
                        <form action='' method='post' enctype="multipart/form-data">
                            <div class="form-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Select Allergies</label>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Select Diets</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-danger">
                                            ...
                                            <input type="text" name="ingredients" class="form-control form-control-danger" value="<?php echo $roww['ingredients']; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
